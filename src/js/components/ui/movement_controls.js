	...
	render() {
		return (
			<div id="UI-right-panel">
				...
				<div id="camera-move">
					<button id="camera-up" onClick={this.props.xUp}><UpArrowSVG /></button>
					<div id="camera-move-horizontal">
						<button id="camera-left" onClick={this.props.zUp}><LeftArrowSVG /></button>
						<button id="camera-right" onClick={this.props.zDown}><RightArrowSVG /></button>
					</div>
					<button id="camera-down" onClick={this.props.xDown}><DownArrowSVG /></button>
				</div>
				<button id="camera-zoom-in" onClick={this.props.yDown}><ZoomInSVG /></button>
				<button id="camera-zoom-out" onClick={this.props.yUp}><ZoomOutSVG /></button>
			</div>
		);
	}
}
